...
public class Principal {
    ...
    public static void main(String[] args) {
        ...
        ps4Games.forEach(e -> System.out.println(e.getClass()));//imprimindo o nome dos jogos de ps4
        System.out.println("");
        ...
        activisionGames.forEach(e -> System.out.println(e.getClass()));//imprimindo o nome dos jogos da activison
